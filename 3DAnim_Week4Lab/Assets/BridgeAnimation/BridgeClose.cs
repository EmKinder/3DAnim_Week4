...
public class BridgeClose : MonoBehaviour
{
    ...
    IEnumerator ThisBridgeOpen1(float waitTime)
    {
        ...
        anim1.SetTrigger("PutBridgeDown");
        ...
        StartCoroutine(ThisBridgeOpen2(waitTime));
          ...
          anim1.GetComponent<Renderer>().enabled = false;

    }
    IEnumerator ThisBridgeOpen2(float waitTime)
    {
        anim2.SetTrigger("PutBridgeDown");
